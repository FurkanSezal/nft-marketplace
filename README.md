...
```
git clone https://github.com/FurkanSezal/nft-marketplace
cd nft-marketplace
yarn
```
...
- `RINKEBY`: This is url of the rinkeby testnet node you're working with. You can get setup with one for free from [Alchemy](https://alchemy.com/?a=673c802981)
